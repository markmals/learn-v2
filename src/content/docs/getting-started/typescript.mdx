...
TypeScript is a _superset_ of JavaScript, meaning any valid JavaScript syntax is valid TypeScript syntax, but TypeScript adds some additional syntax on top of JavaScript — specifically _types_.
